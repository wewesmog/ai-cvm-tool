...
export function EntryNodeModal({ isOpen, onClose, onSave, nodeData }: EntryNodeModalProps) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      // Basic Info
      title: nodeData?.title || "Entry Node",
      description: nodeData?.description || "Starting point of the customer journey",
  ...
  useEffect(() => {
    if (nodeData) {
      form.reset({
        title: nodeData.title || "Entry Node",
        description: nodeData.description || "Starting point of the customer journey",
        audience: nodeData.audience || "phone-number",
        unlimitedParticipants: nodeData.unlimitedParticipants ?? true,
  ...
  const handleSave = () => {
    ...
    console.log('💾 Saving Entry Node configuration:', formData);
    onSave(formData);
    onClose();
  };
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          <Card className="h-full">
            <Tabs value={currentTab} onValueChange={setCurrentTab} className="h-full flex flex-col">
              ...
              <form id="entry-node-form" className="flex-1 flex flex-col">
                <CardContent className="flex-1 overflow-y-auto">
                  <TabsContent value="general" className="space-y-6">
                    <FieldGroup>
                      <Field>
                        <FieldLabel className="text-base font-semibold">Audience</FieldLabel>
                        <FieldDescription className="text-sm">
                          Select the type of audience for this entry point
                        </FieldDescription>
                        <FieldContent>
                          <Controller
                            ...
                            render={({ field, fieldState }) => (
                              <>
                                ...
                                >
                                  ...
                                  <option value="account-no">Account Number</option>
                                </select>
                      ...
                      <Field>
                        <FieldLabel>Unlimited Participants</FieldLabel>
                        <FieldDescription>
                          Allow unlimited participants to enter this journey
                        </FieldDescription>
                        <FieldContent>
                          <Controller
                            control={form.control}
                  ...
                  <TabsContent value="data-source" className="space-y-4">
                    <FieldGroup>
                      <Field>
                        ...
                        <FieldDescription>
                          Choose how to get customer data for this entry point
                        </FieldDescription>
                        <FieldContent>
                          <Controller
                            control={form.control}
                        ...
                        <Field>
                          ...
                          <FieldContent>
                            <Controller
                              ...
                              render={({ field, fieldState }) => (
                                <>
                                  <Input {...field} placeholder="https://api.example.com/customers" />
                                  <FieldError errors={[fieldState.error]} />
                                </>
                              )}
                            />
                        ...
                        <Field>
                          ...
                          <FieldContent>
                            <Controller
                              ...
                              render={({ field, fieldState }) => (
                                <>
                                  <Input {...field} placeholder="user_id, email, phone" />
                                  <FieldError errors={[fieldState.error]} />
                                </>
                              )}
                            />
                  ...
                  <TabsContent value="schedule" className="space-y-4">
                    <FieldGroup>
                      <Field>
                        ...
                        <FieldDescription>
                          Enable scheduling for this entry point
                        </FieldDescription>
                        <FieldContent>
                          <Controller
                            control={form.control}
                  ...
                  <TabsContent value="preview" className="space-y-4">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Preview of your entry node configuration
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-2">
                          ...
                          <p><strong>Audience:</strong> {form.watch("audience")}</p>
